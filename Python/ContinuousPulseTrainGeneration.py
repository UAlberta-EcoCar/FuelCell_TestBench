...
class ContinuousPulseTrainGeneration():
    ...
    Usage:  pulse = ContinuousTrainGeneration(period [s],
            ...
            pulse.clear()
    """
    def __init__(self, period=1., duty_cycle=0.25, counter="Dev1/ctr0", reset=False):
        if reset:
...
if __name__=="__main__":
        pulse_gene1 = ContinuousPulseTrainGeneration(0.00004,0.5, "dev1/ctr0", reset=True)
        pulse_gene1.start()
        #pulse_gene1.stop()
        #pulse_gene1.clear()
        ...
        #pulse_gene1.stop()
        #pulse_gene1.clear()
        #pulse_gene1 = ContinuousPulseTrainGeneration(0.00004, 0.1, "dev1/ctr0", reset=True)
        pulse_gene2 = ContinuousPulseTrainGeneration(0.00004, 0.999, "dev1/ctr1", reset=True)
        #while 1:
        #pulse_gene1.start()
        #time.sleep(1)
        #a = raw_input("Generating pulse train. Press Enter to interrupt\n")
